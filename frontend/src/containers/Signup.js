...
import uiImg from "../images/signup-img.jpeg";
// import uiImg from "../images/login.svg";
import "../css/signup.css";

const Signup = ({ signup, isAuthenticated, isSignup }) => {
  const regexp =
  ...
  return (
    <div className="main-content">
      <div className="signup-img">
        <img className=" mt-5" src={uiImg} alt="" />
      </div>
          ...
          <Row>
            <Col>
              ...
              >
                ...
                {errors.gender && <p className="errorShow">{errors.gender}</p>}
              </Form.Group>
            </Col>
            <Col>
              <Form.Group
          ...
          {isLoading ? (
            ...
            <div className="d-flex justify-content-center">
              <Button
                as="input"
                type="submit"
                value={isLoading ? "Creaing..." : "Signup"}
